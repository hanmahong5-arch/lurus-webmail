...
const features = [
	{
		...
		description:
			"Add Gmail, SES, SendGrid, or any IMAP/SMTP account — Lurus Mail automatically builds a working inbox with threads and attachments.",
		icon: Mail,
	},
	{
		name: "Self-hosted and private",
		description:
			"Run Lurus Mail on your own server or laptop. No external tracking or telemetry — your data and credentials stay fully in your control.",
		icon: Lock,
	},
	{
		name: "Reliable message sync",
		description:
			"Lurus Mail continuously syncs new mail, sent items, and deletions — keeping your local inbox up to date automatically.",
		icon: Server,
	},
	{
	...
	},
	{
		...
		description:
			"Get started in minutes with Docker or run it from source. Lurus Mail runs anywhere — from a personal machine to a VPS.",
		icon: Cpu,
	},
	{
		name: "Open-source and extensible",
		description:
			"Fully open-source under a permissive license. Extend providers, add custom logic, or integrate Lurus Mail into your own projects.",
		icon: ShieldCheck,
	},
];

export default function Lurus MailFeatures() {
	return (
		<section className="bg-white dark:bg-neutral-950 py-24 sm:py-32 transition-colors">
			<div className="mx-auto max-w-7xl px-6 lg:px-8">
				...
				<div className="mx-auto max-w-2xl sm:text-center">
					...
					<p className="mt-6 text-lg text-gray-600 dark:text-gray-300">
						Lurus Mail turns your existing email credentials into a full webmail —
			...
			<div className="relative overflow-hidden pt-16">
				<div className="mx-auto max-w-7xl px-6 lg:px-8">
					<img
						alt="Lurus Mail dashboard preview (light)"
					...
					{/* Dark mode image */}
					<img
						alt="Lurus Mail dashboard preview (dark)"
